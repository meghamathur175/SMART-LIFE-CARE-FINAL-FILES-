...
import HospitalVerificationTable from "../AdminPages/HospitalVerificationTable";
import AgencyVerificationTable from "../AdminPages/AgencyVerificationTable.js";
...
import AgencyLoginForm from "../DriverPages/AgencyLoginForm.js";
import AgencyRegister from "../DriverPages/AgencyRegister.js";
    ...
    <LoginProvider>
      <Routes>
        ...
        <Route path="/partner-dashboard" element={<PartnerSidebar />}>
          ...
          <Route
            path="assign-multiple-ambulances"
            element={<AssignMultipleDrivers />}
          />
        </Route>
        ...
        <Route path="/admin-dashboard" element={<AdminSidebar />}>
          ...
          <Route
            ...
            element={<HospitalVerificationTable />}
          />
          <Route
            path="agency-verification"
            element={<AgencyVerificationTable />}
          />
        </Route>
